...
public class DocumentBenchmarking {
  ...
  public static void main(String[] args) {
    ...
    for (int numToCheck = start;
       ...
       *     b. Calls fleshScore on this org.evanxu.document
      ...
      Long basicRunDuration = (basicEndTime - basicStartTime) / 1_000_000;
      System.out.print(basicRunDuration + "\t");
      ...
      long efficientRunDuration = (efficientEndTime - efficientStartTime) / 1_000_000;
      System.out.print(efficientRunDuration + "\n");
    }
  }
